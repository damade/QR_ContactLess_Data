 ...
 */
    ...
    sendForgotPasswordEmailOtp = async (recipientPhoneNumber: string, recipientEmailAddress: string) => {
        ...
        const send_message = this.emailService.sendForgotPasswordOtp(recipientEmailAddress, otp);
